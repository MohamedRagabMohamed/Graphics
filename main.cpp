...
void GeneralPolygonFill(HDC hdc,POINT *polygon,int n,COLORREF c)
{
    ...
    while (ActiveList.size()>0)
    {
        ...
        for(EdgeList::iterator it=ActiveList.begin(); it!=ActiveList.end(); it++)    it->x+=it->minv;
...
int c = 0 ;
int xs = 0 , xe = 0 , xc = 0 , ys = 0 ,  yc = 0 ,ye = 0;
POINT polg[100];
HDC hdc;
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_LBUTTONDOWN:
            polg[c].x = LOWORD(lParam);
            polg[c].y = HIWORD(lParam);
            hdc = GetDC(hwnd);
            c++;
            break;
    case WM_RBUTTONDOWN:
            ...
            polg[c].y = HIWORD(lParam);
            hdc = GetDC(hwnd);
            GeneralPolygonFill(hdc , polg , ++c , RGB(19,15,23));
            c=0;
        break;
    case WM_DESTROY:
